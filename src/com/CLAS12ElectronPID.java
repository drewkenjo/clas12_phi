...
import src.com.CLAS12ElectronPIDCut;
...
public class CLAS12ElectronPID implements IParticleIdentifier{
	...
	if( event instanceof HipoDataEvent ){
	    ...
	    hipoEv.getHipoEvent().getSchemaFactory().addSchema(new Schema("CLAS12::electron",300,"index/I"));
	    //System.out.println(" >> 3 ");

	    DataBank pidBank = event.createBank("CLAS12PID::electron",1);
