...
import src.com.CLAS12KaonPlusPIDCut;
...
public class CLAS12KaonPlusPID implements IParticleIdentifier{
	...
	if( event instanceof HipoDataEvent ){
	    ...
	    hipoEv.getHipoEvent().getSchemaFactory().addSchema(new Schema("CLAS12::kp",300,"index/I"));
	    //System.out.println(" >> 3 ");

	    DataBank pidBank = event.createBank("CLAS12PID::kp",1);
