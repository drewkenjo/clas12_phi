...
import src.com.CLAS12ProtonPIDCut;
...
public class CLAS12ProtonPID implements IParticleIdentifier{
	...
	if( event instanceof HipoDataEvent ){
	    ...
	    hipoEv.getHipoEvent().getSchemaFactory().addSchema(new Schema("CLAS12::proton",300,"index/I"));
	    //System.out.println(" >> 3 ");

	    DataBank pidBank = event.createBank("CLAS12PID::proton",1);
